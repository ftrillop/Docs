<?php
// index.php
/* as rutas da paxina non son correctas, porque tan cambiadas
en realidade, o que falla son as fotos
que non enlazan, buscar algunha qeu vai ben
e modificar o ficheiro json */
