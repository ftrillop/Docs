...
<html lang="en">
  <head>
    ...
    <title>Xerar arquivo con PHP e PDF </title>
...
<!-- Inicio content -->  
 <div class="container">
 <h1 class="mt-5">Xerar arquivo con PHP e PDF</h1>
 <hr>
<div class="btn btn-primary"><a href="GenerarPDF.php" style="color:#FFF; text-decoration:none; " target="_blank">Ver o PDF</a></div>
